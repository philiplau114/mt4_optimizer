...
def generate_summary_insert(
    ...
    input_html_file, input_set_file, optimization_pass_id  # <-- Add here
):
    ...
    input_html_file, input_set_file, optimization_pass_id
) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
"""
    values = [
        step_id,
...
def process_mt4_report(
    ...
    summary_sql, summary_values = generate_summary_insert(
        ...
        html_file, input_set_file, optimization_pass_id  # <-- Add these two
    )
