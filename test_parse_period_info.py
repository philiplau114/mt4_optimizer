...
if __name__ == "__main__":
    ...
    period_str = "30 Minutes (M30) 2022.09.19 00:00 - 2025.09.16 23:30 (2022.09.17 - 2025.09.17)"
    result = parse_period_info(period_str)
    print("period:", result[0])
    print("data_start_date:", result[1])
    print("data_end_date:", result[2])
    print("backtest_start_date:", result[3])
    print("backtest_end_date:", result[4])